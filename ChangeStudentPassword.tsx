...
const ChangeStudentPassword: React.FC = () => {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      if (!studentNum) throw new Error('Student Number not found');

      setLoading(true);

      const response = await fetch(
        `https://varsitytrackerapi20250619102431-b3b3efgeh0haf4ge.uksouth-01.azurewebsites.net/Access/change_student_password/${studentNum.toUpperCase()}`,
        {
          method: 'PUT',
